...
const HOLD_MS = 40;
const DRAW_TOUCH_START_RATIO_2D = 0.49;
const DRAW_TOUCH_START_RATIO_3D = 0.7;
const DRAW_TOUCH_UNAMBIGUOUS_RATIO_2D = 0.3;
const DRAW_TOUCH_RELEASE_RATIO_2D = 0.55;
const DRAW_TOUCH_RELEASE_RATIO_3D = 0.76;
const DRAW_TOUCH_RELEASE_OVERRIDE_RATIO_2D = 0.36;
